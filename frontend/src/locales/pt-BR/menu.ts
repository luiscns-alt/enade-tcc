export default {
  ...
  'menu.exception.not-permission': 'Desculpe, você não tem permissão para acessar esta página',
  'menu.exception.not-find': 'Desculpe, a página que você visitou não existe',
  ...
  'menu.list.table-questionnaires': 'Lista de Questionários',
